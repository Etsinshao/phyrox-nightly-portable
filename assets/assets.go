...
// sources:
// res/FirefoxNightly.lnk (1.294kB)
...
func firefoxnightlyLnk() (*asset, error) {
	bytes, err := firefoxnightlyLnkBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "FirefoxNightly.lnk", size: 1294, mode: os.FileMode(0666), modTime: time.Unix(1572378781, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"FirefoxNightly.lnk": firefoxnightlyLnk,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"FirefoxNightly.lnk": &bintree{firefoxnightlyLnk, map[string]*bintree{}},
}}
